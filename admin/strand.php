...
<body>
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="card">
                            <div class="card-body">
                                <table id="strand" class="table table-striped dt-responsive nowrap w-100">
                                    <thead></thead>
                                    <tbody></tbody>
                                </table>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addStrandForm">
                            <div class="mb-3">
                                <label for="strandName" class="col-form-label">Strand Name:</label>
    ...
    <script src="scripts/strand.js"></script>
